...
sessionListItemOfMain::sessionListItemOfMain(QWidget *parent) : QWidget(parent)
{

}
sessionListItemOfMain::sessionListItemOfMain(currentAccount *Account, QString message,QString date,QString time)
{
    ...
    layout->addWidget(nameLabel,0,2,1,4);
    layout->addWidget(contentsLabel,1,2,1,6);
    layout->addWidget(timeLabel,0,6,1,2);
